...
def get_classification_report(y_true: np.ndarray, y_pred: np.ndarray, class_mapping: dict):
...
def get_confusion_matrix(y_true: np.ndarray, y_pred: np.ndarray, class_mapping: dict):
...
def get_avg_posteriors(y_true: np.ndarray, y_pred: np.ndarray, posteriors: np.ndarray, class_mapping: dict):
